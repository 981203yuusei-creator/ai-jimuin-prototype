const ROWS: [string, string][] = [
  ...
  ["サービス名", "ジムアシ"],
  ["販売価格", "月額9,800円(税込)。お申込みから30日間は無料でお試しいただけます。"],
  ["販売価格以外に必要な料金", "なし(インターネット接続料金・通信費はお客様のご負担となります)"],
  ["お支払い方法", "クレジットカード決済(Stripe)。お申込み時にご登録いただきますが、無料期間中の請求はありません。"],
  ["お支払い時期", "無料期間(30日間)終了後に初回決済、以降は毎月自動更新にて決済されます"],
  ["サービス提供時期", "お申込み手続き完了後、順次アカウントを発行いたします"],
  [
    "返品・キャンセルについて",
